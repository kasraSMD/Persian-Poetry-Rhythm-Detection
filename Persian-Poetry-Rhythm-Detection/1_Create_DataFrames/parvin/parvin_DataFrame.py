...
if __name__ == "__main__":
    ...
    poem_id = func(poem_id=poem_id, book_name="دیوان اشعار\nقصاید", number_of_poem=42, label="ghaside",
                   path_label="divanp_ghasidep")
    poem_id = func(poem_id=poem_id, book_name="دیوان اشعار\nمثنویات، تمثیلات و مقطعات", number_of_poem=181, label=None,
                   path_label="divanp_mtm")
