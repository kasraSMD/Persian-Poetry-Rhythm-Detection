...
if __name__ == "__main__":
    ...
    poem_id = func(poem_id=poem_id, book_name="گزیدهٔ غزلیات", number_of_poem=160, label="ghazal",
                   path_label="gozidegh")
    poem_id = func(poem_id=poem_id, book_name="گزیدهٔ اشعار ترکی", number_of_poem=30, label=None,
                   path_label="torki")
