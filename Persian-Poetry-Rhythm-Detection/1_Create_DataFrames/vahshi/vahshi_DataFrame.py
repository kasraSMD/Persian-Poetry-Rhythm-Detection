...
if __name__ == "__main__":
    ...
    poem_id = func(poem_id=poem_id, book_name="قصاید", number_of_poem=41, label="ghaside",
                   path_label="divanv_ghasidev")
    poem_id = func(poem_id=poem_id, book_name="غزلیات", number_of_poem=397, label="ghazal",
                   path_label="divanv_ghazalv")
    poem_id = func(poem_id=poem_id, book_name="قطعات", number_of_poem=43, label="ghete",
                   path_label="divanv_ghete-vahshi")
    poem_id = func(poem_id=poem_id, book_name="مثنویات", number_of_poem=8, label="masnavi",
                   path_label="divanv_masnaviatv")
    poem_id = func(poem_id=poem_id, book_name="رباعیات", number_of_poem=66, label="robaee",
                   path_label="divanv_robaee-vahshi")
    poem_id = func(poem_id=poem_id, book_name="ترجیعات", number_of_poem=1, label="tarjee",
                   path_label="divanv_tarjeeat-vahshi")
    poem_id = func(poem_id=poem_id, book_name="ترکیبات", number_of_poem=11, label="tarkib",
                   path_label="divanv_tarkibatv")
    poem_id = func(poem_id=poem_id, book_name="فرهاد و شیرین", number_of_poem=44, label="masnavi",
                   path_label="farhad-shirin")
    poem_id = func(poem_id=poem_id, book_name="خلد برین", number_of_poem=9, label="masnavi",
                   path_label="khold-barin")
    poem_id = func(poem_id=poem_id, book_name="ناظر و منظور", number_of_poem=31, label="masnavi",
                   path_label="nazer-manzoor")
